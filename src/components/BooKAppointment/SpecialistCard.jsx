...
export default function SpecialistCard() {
  return (
    <div className="card-hover w-[95%] sm:w-[30%] md:w-[45%] lg:w-[30%] justify-between flex relative rounded-xl shadow-services-card  cursor-pointer gap-4 pr-2">
      ...
      <div className="flex-1 basis-[70%] flex flex-col gap-4">
        <p className="text-primary text-sm md:text-lg lg:text-xl font-[900] mt-2">Dr. Sunday Anderson</p>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center relative">
          <p className="text-[.8rem] flex items-center text-primary font-[500] w-full lg:w-4/6">
           <span><MdLocationPin /></span> unn teaching hospital
          </p>
          <button className="w-full lg:w-2/6 text-xs bg-primary text-white px-1 py-2 rounded-md ">
            Book Now
          </button>
        </div>
      </div>
